...
static int fineoffset_WH24_callback(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    //printf("{\"time\" : \"%s\", \"model\" : \"Fineoffset-WH4000\", \"id\" : %d, \"battery\" : \"%s\", \"temperature_C\" : %.01f, \"humidity\" : %d, \"wind_dir_str\" : \"%s\", \"wind_dir_deg\" : %d, \"wind_avg\" : %.1f, \"wind_gust\" : %.1f, \"rain_mm\" : %.1f, \"uv\" : %d, \"uvi\" : %d, \"light_lux\" : %.1f, \"mic\" : \"CRC\"}\n",buffer, id, low_battery ? "LOW" : "OK", temperature, humidity, wind_dir_string[wind_dir_index], wind_dir, wind_speed_ms * 3.6f, gust_speed_ms * 3.6f, rainfall_mm, uv_raw, uv_index, light_lux);
    ...
    if(fpWH4000 != NULL){
        fprintf(fpWH4000, "{\"time\" : \"%s\", \"model\" : \"Fineoffset-WH4000\", \"id\" : %d, \"battery\" : \"%s\", \"temperature_C\" : %.01f, \"humidity\" : %d, \"wind_dir_str\" : \"%s\", \"wind_dir_deg\" : %d, \"wind_avg\" : %.1f, \"wind_gust\" : %.1f, \"rain_mm\" : %.1f, \"uv\" : %d, \"uvi\" : %d, \"light_lux\" : %.1f, \"mic\" : \"CRC\"}\n",buffer, id, low_battery ? "LOW" : "OK", temperature, humidity, wind_dir_string[wind_dir_index], wind_dir, wind_speed_ms * 3.6f, gust_speed_ms * 3.6f, rainfall_mm, uv_raw, uv_index, light_lux);
        fclose(fpWH4000);
