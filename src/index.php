  ...
  <div class="r1">
    ...
    <table width="100%" height="70px" border="0">
      <tr>
        ...
        <td valign="top"><br>
          <font size="5"><?php echo $wind_ave; ?> km/h </font>
          <br><?php echo $wind_gust; ?> km/h di raffica<br>
          ...
          <br><br>PM 2.5: <?php echo $pm25; ?> µm
          <br>PM 10: <?php echo $pm10; ?> µm
        </td>
  ...
  <div class="l1">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <br><?php echo $rain-$rainday; ?> mm Day
        <br><?php echo round($rain24 ,1); ?> mm 24H
        <br><?php echo round($rain-$rainweek ,1); ?> mm Week
        <br><?php echo round($rain-$rainmonth ,1); ?> mm Month
        <br><?php echo round($rain_rate,2); ?> % Rate
         </td>
         <td align="center">
           <canvas data-type="linear-gauge"
                   data-width="100dp"
  ...
  <div class="l1">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td style="background:url(https://www.meteo60.fr/satellites/animation-satellite-ir-france.gif); background-repeat:no-repeat; background-position:right 0px bottom -70px;" width="100%" height="190px"></td>
