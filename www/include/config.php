...
include ('/var/www/html/readcfg.php');
...
define('SSH_PASS', trim($web_pwd_data)); //your ssh password, default is "raspberry"
...
define('LOGIN_PASS', trim($web_pwd_data)); //set password for login

define('GUMCP_DEBUG', true); //change to true to show PHP errors, or false to hide errors
...
$gumcp_modules = array(
	'meteopi' => array(
		'module_title' => 'MeteoPI',
		'module_index_file_relative_path' => './meteopi.php',
