...
foreach($gumcp_modules as $key => $module)
{
	...
	if($module['module_active']==1)
	{
		/*if($module['module_show_in_iframe']==1)
		{
			...
			{
				if($key=='accesspoint'){
					echo '<li class="active"><a href="./iframe.php?module='.$key.'" target="_blank">'.$module['module_title'].'</a></li>';
		...
		else*/
		{
			...
			{
				if($key=='accesspoint'){
					echo '<li class="active"><a href="'.$module['module_index_file_relative_path'].'" target="_blank">'.$module['module_title'].'</a></li>';
				}else{
			...
			{
				if($key=='accesspoint'){
					echo '<li><a href="'.$module['module_index_file_relative_path'].'" target="_blank">'.$module['module_title'].'</a></li>';
				}else{
