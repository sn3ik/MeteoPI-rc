...
<head>
  ...
  <script language="JavaScript" type="text/javascript">
      ...
      /*function nightday(orarioAlba, orarioTramonto)
      {
        ...
        xhttp.open("GET", "test.php?soleSorge="+orarioAlba+"&soleTramonta="+orarioTramonto, true);
        xhttp.send();
      }*/
...
$cloud = ((((  ($row[6]-$row[15]) *1.8/4.5 ) * 1000 ) + ($alt * 3.2808) ) / 3.2808);
