...
<body onload="start()" >
  ...
  <nav class="navbar">
      ...
      <div id="side-menu" class="side-nav">
          ...
          <a href="#">Home</a>
          <a href="#" onclick="popupCenter({url: 'graphics.php', title: 'xtf', w: 700, h: 500});">Andamento Oggi</a>
          <a href="#" onclick="popupCenter({url: 'graphics.php?ORE=3', title: 'xtf', w: 700, h: 500});">Andamento Ore</a>
          <a href="#" onclick="popupCenter({url: 'minmax.php', title: 'xtf', w: 300, h: 500});">Min & Max</a>
...
************************** -->
  <div class="l1">
   ...
   <span class="h2"><image src='image/down.png' width=10><span class="min"> <?php echo $TempOutMin; ?>°</span> | <image src='image/up.png' width=10> <span class="max"><?php echo $TempOutMax; ?>°</span>
  </div>
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <br> Stato: <span class="light_blu"> <?php echo $txt_meteo ; ?>
         ...
         <td align="center"><br>
           <image src=<?php echo $ico_meteo;?> width=90%></font>
         </td>
     </tr>
    </table>
    <br>
    <span class="h2"><image src='image/down.png' width=10><span class="min"> <?php echo round($UmOutMin,1); ?>%</span> | <image src='image/up.png' width=10> <span class="max"><?php echo round($UmOutMax,2); ?>%</span>
  </div>
  ...
  <div class="r1">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td valign="top"><br>
          <font size="5"><?php echo $wind_ave; ?> km/h </font> <br><br>da <?php echo $wind_dir_code; ?>
          <br>Raffica <?php echo $wind_gust; ?> km/h
          <br>T. del vento <?php echo round($wind_chill, 1); ?>°C
          <br><span class="light_blu"><?php echo $wind_nome ." - ". $wind_vel_tipo; ?></span>
        </td>
    ...
    <span class="h2">Vmax <span class="light_orange"><?php echo $winDayMax; ?></span> km/h | Rmax <span class="max"> <?php echo $winDayGustMax; ?></span> km/h
  </div>
  ...
  <div class="l1">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td valign="top"><br>
        <font size="5"><?php echo $rain_rate; ?> mm</font><br>
        <br><?php echo $rain_1h; ?> mm 1h
        <br><?php echo $rain_24h; ?> mm 24H
        <br>Tot <?php echo $rain; ?> mm
         </td>
         <td align="center">
           <canvas data-type="linear-gauge"
                   data-width="100dp"
    ...
    <span class="h2">Totale <span class="max"><?php echo $rain_tot; ?></span> mm
  ...
  <div class="m1">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td valign="top"><font size="5"><br><?php echo round($pressure,1); ?> hPa</font>
          <br>
          <br><image src=<?php echo $ico_tendenza;?> width=15>
    ...
    <span class="h2"> <image src='image/down.png' width=10><span class="min"> <?php echo round($PressureMin,1); ?></span> hPa | <image src='image/up.png' width=10> <span class="max"><?php echo round($PressureMax,1); ?></span> hPa</span></span>
  </div>
  ...
  ************************** -->
  <div class="r1">
    ...
    <span class="h2"> Giorno: <span class="min"> <?php echo $leng_cpr; ?></span> | Notte: <span class="max"> <?php echo $le_night; ?></span> </span></span>
  </div>
  ...
  ************************** -->
  <div class="l1">
    ...
    <table width="100%" border="0">
      <tr>
        <td style="background:url(https://sat24.mobi/Image/satir/europa/it); background-repeat:no-repeat; background-position:center;" width="100%" height="150px"></td>
        </tr>
     </table>
  ...
  ************************** -->
  <div class="m1">
    <span class="h1">Effemeridi Sole e Luna</span>
    <table width='100%' border='0'>
  ...
  ************************** -->
  <div class="r1">
    ...
    <table width="100%" border="0">
      <tr>
        <td style="background:url(http://allarmi.meteo-allerta.it/images/map/lazio_index.png); background-repeat:no-repeat; background-position:center;" width="100%" height="150px"></td>
        </tr>
     </table>
     <span class="h2"><a href="http://allarmi.meteo-allerta.it/lazio-index.html" target="_blank">meteo-allerta.it</a></span>
  </div>
  ...
  ************************** -->
  <div class="m1">
    ...
    <table width="100%" border="0">
      <tr>
        <td align="center" >
        <img width="100%" src="http://www.foreca.it/meteogram.php?loc_id=103176738&amp;mglang=it&amp;units=metrickmh&amp;tf=24h">
        </td>
      </tr>
     </table>
  ...
  ************************** -->
  <div class="r1">
    ...
    <table width="100%" border="0">
      <tr>
        <td onClick="popupCenter({url: '<?php if($img_valid){echo $img_cam_path;}else{echo $img_no_available;}  ?>', title: 'xtf', w: 700, h: 500});"   style="background:url(<?php if($img_valid){echo $img_cam_path;}else{echo $img_no_available;}  ?>);  background-position:bottom;  background-size: 400px;" width="100%" height="150px"></td>
      </tr>
     </table>
