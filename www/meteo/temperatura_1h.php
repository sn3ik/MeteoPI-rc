...
$sql = "SELECT * FROM  `METEO` WHERE  `TIMESTAMP_LOCAL` > NOW( ) - INTERVAL 1 HOUR ORDER BY  `METEO`.`TIMESTAMP_LOCAL` ASC ";
...
<html>
 ...
 <body>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Andamento Temperatura ultima ora</h2>
...
Morris.Line({
 ...
 xkey:'timestamp',
 ykeys:['temperatura'],
 ymax: <?php echo $ymax; ?>+0.2,
 ymin: <?php echo $ymin; ?>-0.2,
 labels:['temperatura'],
 hideHover:'auto'//,
 //stacked:true
});
