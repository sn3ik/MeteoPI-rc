			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<div id="system-status" class="panel panel-default" style="margin-bottom: 5px">
					...
					<div class="panel-body">
						...
						<form method="post" style="margin-top: 20px;">
							<div class="form-group row">
								<label class="col-sm-2 form-control-label">Shutdown RPi</label>
								<input type="hidden" class="form-control" name="action" value="shutdown">
								<div class="col-sm-4">
									<button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure to shutdown RPi?')">Shutdown</button>
								</div>
							</div>
